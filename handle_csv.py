...
def request_to_list(r_flatten_list, group_step):
    ...
    for i in range(0, len(r_flatten_list), group_step):
        ...
        r = requests.get("http://hq.sinajs.cn/list=" + sub_flatten_str, headers={'Referer': 'https://stock.finance.sina.com.cn'})
...
if __name__ == '__main__':
    ...
    with open(CSV_PATH, 'r') as f:
        ...
        stock_list2 = request_to_list(flatten_list, 50)
        import copy
        stock_list = copy.deepcopy(stock_list2)
        ...
        context["stock_list"] = stock_list2
